...
VCommSessionEventProducerWeakPtr VCommSessionEventProducerFactory::CreateCommSessionEventProducer(const Vu32 minimumPollingThreads,
    ...
    auto csep = std::make_shared<VEventProducer>(COMM_SESSION_EVENT_PRODUCER_NAME, minimumPollingThreads, maximumEventsPerPollingThread);
...
const std::string VCommSessionEventProducerFactory::COMM_SESSION_EVENT_PRODUCER_NAME = "EPOLLCommSessionEventProducer";
